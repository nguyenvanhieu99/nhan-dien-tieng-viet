...
#         file = "record.wav"
    ...
    def UI(self): 
        ...
        window.title("Nhận diện từ tiếng việt")
        ...
        btn_draw = tk.Button(master=frame2, width=13, height=2, text="draw", fg="#4299e1", command=self.drw)
